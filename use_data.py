...
for loadcase in range(1,4):
    ...
    plt.tight_layout()
    plt.show()
    # comp_data(data.x, data.phi, data.phi_v, label="Validation", label0="Verification", vertlabel="phi", unit="rad")
    # comp_data(data.x, data.vh, data.v_v, label="Validation", label0="Verification", vertlabel="v", unit="m")
    # comp_data(data.x, data.w, data.w_v, label="Validation", label0="Verification", vertlabel="w", unit="m")
